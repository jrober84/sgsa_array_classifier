...
<body>
  <div class="container">
    <h1>
        <strong>SGSA</strong>
        <strong><font size="3" color="#428BCA"><br/><i>Salmonella </i>GenoSerotyping Array<br/></font></strong>
    </h1>
<br/>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="raw_data">
        ...
        <br/>
        <form id="data" role="form" action="dUpload.php" method="post" enctype="multipart/form-data">
...
<br/>
    ...
    <div id="status"></div>
<br/>
    <p class="text-left"><a href=""><strong><i>Salmonella</i> serotypes supported</strong></a></p><br>
</p>

  </div>
    <p class="text-center">Copyright 2015 @ National Microbiology Laboratory at Guelph.</p>
    <p class="text-center"><a href="mailto:nml.sgsa@gmail.com">Contact us</a></font></p>
</p>
  </div>
